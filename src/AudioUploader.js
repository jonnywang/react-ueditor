    ...
    renderAudioConfig = () => {
        ...
        return (
            <form style={style.paramsConfig}>
                <Label name='controls'>
                    <Select defaultValue={controls} onChange={e => {
                        this.changeConfig(e, 'controls')
                    }}>
                ...
                <Label name='autoplay'>
                    <Select defaultValue={autoplay} onChange={e => {
                        this.changeConfig(e, 'autoplay')
                    }}>
                        <option value='true'>true</option>
                        <option value='false'>false</option>
                    </Select>
                ...
                <Label name='loop'>
                    <Select defaultValue={loop} onChange={e => {
                        this.changeConfig(e, 'loop')
                    }}>
                        <option value='true'>true</option>
                        <option value='false'>false</option>
                    </Select>
                ...
                <Label name='poster'>
                    <Input type='text' defaultValue={poster} onChange={e => {
                        this.changeConfig(e, 'poster')
                    }} />
                </Label>
                <Label name='name'>
                    <Input type='text' defaultValue={name} onChange={e => {
                        this.changeConfig(e, 'name')
                    }} />
                </Label>
                <Label name='author'>
                    <Input type='text' defaultValue={author} onChange={e => {
                        this.changeConfig(e, 'author')
                    }} />
                </Label>
            </form>
        )
