            ...
            <div style={modalStyle}>
                ...
                <div style={imageContainerStyle} onClick={handleClick}>
                    <img style={imageStyle}
                        src='https://cloud-minapp-7894.cloud.ifanrusercontent.com/1hGIy5OFK4JMKqxA.png' />
                    <img style={imageStyle}
                        src='https://cloud-minapp-7894.cloud.ifanrusercontent.com/1gAVF3QpMa7cvWYz.jpg' />
                </div>
            </div>
        </div>
    )
...
let uploadImagePlugin = function(ueditor) {
    return {
        ...
        onIconClick: function() {
            console.log('imageUpload icon click')
        },
...
let previewHtml = function(ueditor) {
    return {
        menuText: '图片上传',
        cssRules: 'background-position: -726px -77px;',
        onIconClick: function() {
