...
var ReactUeditor = /*#__PURE__*/function (_React$Component) {
  ...
  function ReactUeditor(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "registerUploadVideo", function () {
      var uploadVideo = _this.props.uploadVideo;
      return _this.registerPlugin(function (ueditor) {
        return {
          menuText: '上传视频',
          ...
          render: function render() {
            return /*#__PURE__*/_react["default"].createElement(_VideoUploader["default"], {
              upload: uploadVideo,
              progress: _this.state.videoProgress,
              onChange: _this.videoChange
            });
          },
          onConfirm: function onConfirm() {
            var videoHtml = _this.state.videoHtml;
        ...
        return {
          ...
          render: function render() {
            return /*#__PURE__*/_react["default"].createElement(_AudioUploader["default"], {
              upload: uploadAudio,
              progress: _this.state.audioProgress,
              onChange: _this.audioChange
            });
          },
          onConfirm: function onConfirm() {
            var audioHtml = _this.state.audioHtml;
    ...
    _defineProperty(_assertThisInitialized(_this), "updateVideoProgress", function (p) {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateAudioProgress", function (p) {
      _this.setState({
        audioProgress: p
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "handlePasteImage", function () {
      var _this$props = _this.props,
          pasteImageStart = _this$props.pasteImageStart,
          handlePasteImage = _this$props.handlePasteImage,
          pasteImageDone = _this$props.pasteImageDone;
  ...
  _createClass(ReactUeditor, [{
    ...
    value: function registerPlugin(plugin) {
      ...
      var name = plugin.name || Math.random().toString(36).slice(2);
      window.UE.registerUI(name, function (ueditor, uiName) {
        ...
        var btn = new window.UE.ui.Button({
          ...
          onclick: isModalMode(config.mode) ? function () {
            _this3.setState(_defineProperty({}, _this3.getVisibleName(name), true));
